...
SCHEME_KEYWORDS: Dict[str, List[str]] = {
    ...
    "SH000B51": ["pm vishwakarma scheme", "pm vishwakarma", "vishwakarma yojana"],
    "SH000BGH": ["prime minister employment generation program", "pmegp"],
    "SH000889": ["stand up india", "standup india"],
    ...
    "SH0008C6": ["59 minutes loan gst", "msme loan 59 minutes gst"],
    "SH0008C7": ["59 minutes loan", "msme loan 59 minutes"],
    ...
    "SH000BEX": ["e-commerce onboarding"],
    "SH000A16": ["food aggregator onboarding"],
    "SH000A17": ["swiggy onboarding"],
    "SH000A2E": ["fssai registration"],
    "SH000AD3": ["fssai state license"],
    ...
    "SH0008RA": ["maitri portal", "single window registration"],
    "SH0008PI": ["interest subsidy ksfc"],
    "SH0008RM": ["interest subsidy sc/st", "karnataka scst interest"],
    "SH0008RN": ["term loan ksfc"],
    "SH0008RO": ["amara", "marketing related activities"],
    "SH0009ZJ": ["mukhya mantri krishak udyami"],
    "SH000DNC": ["mukhyamantri udyami"],
}
